...
class View_All_Projects extends Component {
    render(){
        ...
        {title: 'Burger Palace', desc:'Full stack website which was designed for a fast food chain company called "Burger Palace". Website uses HTML, SASS, JavaScript, PHP & Responsive Design', image: {src: BurgerPalace, alt: 'BurgerPalaceImg'}, feature:true, openLink: 'https://joshuasprogramming.github.io/Burger-Palace-Responsive/', },
