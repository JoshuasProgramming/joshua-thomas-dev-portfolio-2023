                ...
                <>
                    {/* <Router> */}
                        ...
                        <div className="right">
                            ...
                            <p>{value.desc}</p>
                            <div className="info">
                                <Link to="../pages/Read_more" state={{title: value.title, image: value.image.src, alt: value.image.alt, paragraph1: value.paragraph1}} style={{ textDecoration: 'none' }}  >Read more &#x27a4;</Link>
