...
class View_All_Projects extends Component {
    render(){
        ...
        {title: 'Kocoon', desc:'We are an educational platform that focuses on the wellbeing by presenting academic papers for everyone.' , image: {src: kocoon, alt: 'kocoon'}, feature:false, featureAll:true, language1:'HTML', language2:'SCSS', language3:'Responsive Design', language4:'Freelance Work', language5: 'JavaScript', openLink:'https://joshuasprogramming.github.io/Kocoon', githubRepo: 'https://github.com/JoshuasProgramming/Kocoon'},
