                ...
                <>
                    {/* <Router> */}
                        ...
                        <div className="right">
                            ...
                            <p>{value.desc}</p>
                            <div className="info">
                                <Link to="../pages/Read_more" state={{title: value.title, image: value.image.src, alt: value.image.alt, code_snippet1: value.code_snippet1, paragraph1: value.paragraph1, paragraph2: value.paragraph2}} style={{ textDecoration: 'none' }}  >Read more &#x27a4;</Link>
