...
import cryptoway from '../images/cryptoway.png';
...
import FoodDX_snippet_1 from '../read_more_code_snippets/FoodDX_snippet_1.png';
import FoodDX_snippet_2 from '../read_more_code_snippets/FoodDX_snippet_2.png';
import fetchApis_snippet_1 from '../read_more_code_snippets/fetchApis_snippet_1.png';
import burgerPalace_snippet_1 from '../read_more_code_snippets/burgerPalace_snippet_1.png';
import burgerPalace_snippet_2 from '../read_more_code_snippets/burgerPalace_snippet_2.png';
...
export default function Read_More() {
  ...
  const projects = [
    ...
    console.log(location.state.githubRepo);
    ...
    //create variable for the user to download the zip of any project
  ...
  return (
    <section className="read-more-container">
      ...
      <div className="read-more-icons">
        ...
        {location.state.githubRepo == 'https://github.com/JoshuasProgramming/joshua-thomas-dev-portfolio-2023' ? 
          ...
          location.state.openLink == undefined ? 

          <a>
          <img src={na} title="project in development"/>
          </a>
      ...
      {location.state.code_snippet1 === undefined ? false :
